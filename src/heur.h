...
double VNS(instance *inst, int *preds, double best_score)
{
    int i, j, k, three_opt_cnt, oom_improvement = 0;
    double score, oom_best_score, tom_best_score, tmp, eval_preds;
